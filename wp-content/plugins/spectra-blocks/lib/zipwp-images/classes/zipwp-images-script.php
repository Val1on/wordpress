	...
	public function load_script(): void {
		...
		$data = apply_filters(
			...
			array(
				...
				'title'                => apply_filters( 'zipwp_images_tab_title', __( 'Search Images', 'spectra-blocks' ) ),
				'search_placeholder'   => __( 'Search - Ex: flowers', 'spectra-blocks' ),
				'downloading'          => __( 'Downloading...', 'spectra-blocks' ),
				'validating'           => __( 'Validating...', 'spectra-blocks' ),
