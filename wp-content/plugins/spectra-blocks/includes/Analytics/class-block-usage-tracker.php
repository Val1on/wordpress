...
namespace SpectraBlocks\Analytics;
...
class BlockUsageTracker {
	...
	private function build_root_blocks_list( $block_prefix = 'spectra' ) {
		...
		if ( 'spectra-pro' === $block_prefix ) {
			...
			$possible_dirs = array(
				WP_PLUGIN_DIR . '/spectra-blocks-pro/build/blocks/',
				WP_PLUGIN_DIR . '/spectra-blocks-pro/src/blocks/',
			);
	...
	private function is_spectra_pro_available() {
		...
		$pro_plugin_dir = WP_PLUGIN_DIR . '/spectra-blocks-pro';
